...
const Read_Comu = () => {
  ...
  return (
    <div
      className={
        edit_com ? "avisos-mayor-container-add" : "avisos-mayor-container"
      }
      ref={container}
    >
      <div className="avisos-list-cont">
        <div
          className={
            filter_avisos(avisos)[0] == undefined ? "avisos-list-vacio" : "avisos-list"
          }
        >
          {!edit_com && (
            <>
          ...
          {filter_avisos(avisos)[0] == undefined && !edit_com && (
            <>
              ...
              <strong style={{ marginBottom: 50 }}>
                Aqui estaran los avisos para tu grupo
              </strong>
            </>
          )}
        </div>
