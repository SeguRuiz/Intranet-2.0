...
detalles = {
    "tardia": f"El estudiante ingresó tarde a la clase del {timezone.now().date().strftime("%d/%m/%Y")}. El retraso fue registrado conforme a los lineamientos establecidos en el sistema de asistencia.",
    "ausente": f"El estudiante no se presentó a la clase correspondiente en la fecha siguiente {timezone.now().date().strftime("%d/%m/%Y")}. Se registró como ausencia según los parámetros establecidos para el control de asistencia.",
    "retiro": f"El estudiante se retiró antes de finalizar la clase del {timezone.now().date().strftime("%d/%m/%Y")}. Este evento quedó registrado como retiro anticipado en el reporte de asistencia.",
}
...
Se ha registrado un ingreso tardío del estudiante **{estudiante_nombre}** en la clase del **{timezone.now().date().strftime("%d/%m/%Y")}**, {presento_aviso}.  
...
Se ha registrado una ausencia del estudiante **{estudiante_nombre}** en la clase del **{timezone.now().date().strftime("%d/%m/%Y")}**, {presento_aviso}.  
...
Se ha registrado un **retiro anticipado** del estudiante **{estudiante_nombre}** en la clase del **{timezone.now().date().strftime("%d/%m/%Y")}**, {presento_aviso}.  
            ...
            for n in asistencias:
                ...
                if n["info"]["estado"] != "presente":
                    nuevo_reporte = Reportes_info(
                        ...
                        usuario_id=profesor,
                        dia_incidente=timezone.now().date(),
